...
public class Constants
{
    ...
    public readonly static string iOSAppName = "com.companyname.Inventory.Frontend";
    public readonly static string AndroidAppName = "com.companyname.Inventory.Frontend";
